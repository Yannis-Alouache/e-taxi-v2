  ...
  return (
    <>
      <div id="bookingBanner" className='xl:h-80 bg-amber-400 -mt-[4.35em] pt-28 md:pt-28 xl:pt-0 flex items-center justify-center'>
          <div className='lg:container lg:mx-auto container mx-auto px-5 lg:px-5  '>
            <div className="grid xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-4 sm:grid-cols-2 gap-3">
              ...
              <div className="relative mt-1 rounded-md shadow-sm">
                <Combobox value={addressDepart} name="depart">
                  ...
                  className={addressDepartError
                    ...
                    />
                  <Combobox.Options className="bg-white z-20 text-gray-900 absolute transform rounded-md inline-block top-[110%] md:w-[200%] sm:w-[100%] lg:w-[160%] w-[100%]">
              ...
              <Combobox value={addressArrive} name="depart">
                  ...
                  className={addressArriveError
                    ...
                    : "block w-full rounded-md text-gray-900 border-gray-300 sm:text-sm xl:text-base focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 px-10 py-3" }
                    />
                  <Combobox.Options className="bg-white z-20 text-gray-900 absolute transform rounded-md inline-block top-[110%] sm:w-[100%] md:w-[200%] w-[100%]">
