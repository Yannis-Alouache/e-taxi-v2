...
function Services() {
  return (
    <>
        <div id='services' className='mb-32 sm:mb-20 mt-24'>
            <div className='container mx-auto lg:px-6 md:px-6 sm:px-6 px-40 py-10'>
                        ...
                        {services.map((service) => {
                            return (
                                <div key={service.key} className={styles.withSeparator}>
                                    <div className="relative w-24 h-24 mx-auto md:mb-4 lg:mb-2 sm:mt-5 sm:mb-5">
                                        <Image src={service.image} alt={service.alt} fill={true} />
                                    </div>
                                    <h3 className='text-gray-900 text-xl sm:mb-1 md:mb-1 lg:mb-3 xl:mt-10 xl:mb-3 uppercase font-bold'>{service.title}</h3>
