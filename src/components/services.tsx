  ...
  return (
    <>
        <div id='services' className='mb-32 mt-24'>
            <div className='container mx-auto lg:px-6 md:px-6 px-40 py-10'>
                <div className="text-center">
                    <h2 className="text-3xl font-bold tracking-tight md:mb-4 lg:mb-10 text-gray-900 sm:text-4xl xl:mb-20">Nos Services</h2>
                        ...
                        {services.map((service) => {
                            return (
                                <div key={service.key} className={styles.withSeparator}>
                                    <div className="relative w-24 h-24 mx-auto md:mb-4 lg:mb-2">
                                        <Image src={service.image} alt={service.alt} fill={true} />
                                    </div>
                                    <h3 className='text-gray-900 text-xl md:mb-1 lg:mb-3 xl:mt-10 xl:mb-3 uppercase font-bold'>{service.title}</h3>
